...
parser.add_argument("-p", "--positions-file", type=argparse.FileType('r'), help='Path to the file containing the x, y, z coordinates of atoms', dest="atomPos", metavar="atom_position_file")
...
#FIXME : N'arrive pas à lire le fichier atomPos ???? 
